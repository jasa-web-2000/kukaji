<footer class="mt-10">
    <div class="bg-white flex items-center justify-between shadow rounded-lg p-4 m-4 text-sm">

        <p class="text-gray-500">Kembali ke halaman <a class="underline"
                href={{ route('landing.index') }}>{{ config('app.name') }}</a></p>

        <a target="_blank"
            class="ps-3 border-l-2 border-l-gray-400 hover:border-l-gray-400 text-gray-500 hover:text-gray-900"
