...
@section('content-dashboard')
    <div class="col-span-full!">
        ...
        <x-dashboard.header-table page="{{ $page }}" url="{{ route('dashboard.speaker.create') }}" />
                ...
                <tbody>
                    @forelse ($data as $item)
                        <tr>
                            ...
                            <td>
                                <x-dashboard.action-table :edit="route('dashboard.speaker.edit', ['speaker' => $item])" :destroy="route('dashboard.speaker.destroy', ['speaker' => $item])" :item="$item"
                                    column="name" />
                            </td>
                        </tr>
                    @empty
